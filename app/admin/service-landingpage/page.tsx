...
import { Plus, Edit, Trash2, Search, Layers, RefreshCw, AlertCircle } from 'lucide-react';
...
export default function ServicePage() {
  ...
  const handleAdd = () => router.push('/admin/service-landingpage/new');
  const handleEdit = (item: ServiceItem) => router.push(`/admin/service-landingpage/${item.id}/edit`);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl sm:text-2xl font-bold">Service Landing Page Management</h1>
            <button
          ...
          <div className="bg-gray-800 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-4">
              {searchTerm
                ...
                : "Start by adding your first Service content"}
            </p>
            {!searchTerm && (
              <button
                onClick={handleAdd}

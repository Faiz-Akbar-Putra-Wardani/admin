  ...
  useEffect(() => {
    const filtered = data.filter(
      (item) =>
        ...
        item.position_client?.toLowerCase().includes(searchTerm.toLowerCase()) ||
        item.description_client?.toLowerCase().includes(searchTerm.toLowerCase())
    );
              ...
              <tbody className="divide-y divide-gray-700">
                {filteredData.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-750 transition">
                    <td className="px-4 py-3 text-sm text-gray-100">{item.name_client}</td>
                    <td className="px-4 py-3 text-sm text-gray-200 whitespace-pre-line">{item.description_client}</td>
                    <td className="px-4 py-3 text-sm text-gray-200 whitespace-pre-line">{item.position_client}</td>

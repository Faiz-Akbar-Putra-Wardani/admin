...
import { Plus, Edit, Trash2, Search, Users, RefreshCw, AlertCircle, FileText } from 'lucide-react';
...
const [confirmDeleteItem, setConfirmDeleteItem] = useState<AboutUsData | null>(null);
          ...
          <table className="min-w-full divide-y divide-gray-700 bg-gray-800 rounded-xl overflow-hidden">
            <thead className="bg-gray-900">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-300">Vision</th>
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-300">Mission</th>
              ...
              <tbody className="divide-y divide-gray-700">
                {filteredData.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-750 transition">
                    <td className="px-4 py-3 text-sm text-gray-100">{item.title}</td>
                    <td className="px-4 py-3 text-sm text-gray-200 whitespace-pre-line">{item.description}</td>
                    <td className="px-4 py-3 text-sm text-gray-200 whitespace-pre-line">{item.vision}</td>
                    <td className="px-4 py-3 text-sm text-gray-200 whitespace-pre-line">{item.mission}</td>

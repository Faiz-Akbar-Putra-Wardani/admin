...
import { Plus, Edit, Trash2, Search, Users, RefreshCw, AlertCircle, ArrowLeft, Info } from 'lucide-react';
...
export default function TeamPage() {
  ...
  const [confirmDeleteItem, setConfirmDeleteItem] = useState<TeamMember | null>(null);
